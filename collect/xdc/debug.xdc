...
connect_debug_port u_ila_0/probe1 [get_nets [list {usb_dut/com_rxd[0]} {usb_dut/com_rxd[1]} {usb_dut/com_rxd[2]} {usb_dut/com_rxd[3]} {usb_dut/com_rxd[4]} {usb_dut/com_rxd[5]} {usb_dut/com_rxd[6]} {usb_dut/com_rxd[7]}]]
create_debug_port u_ila_0 probe
set_property PROBE_TYPE DATA_AND_TRIGGER [get_debug_ports u_ila_0/probe2]
set_property port_width 8 [get_debug_ports u_ila_0/probe2]
connect_debug_port u_ila_0/probe2 [get_nets [list {usb_dut/com_txd[0]} {usb_dut/com_txd[1]} {usb_dut/com_txd[2]} {usb_dut/com_txd[3]} {usb_dut/com_txd[4]} {usb_dut/com_txd[5]} {usb_dut/com_txd[6]} {usb_dut/com_txd[7]}]]
create_debug_port u_ila_0 probe
set_property PROBE_TYPE DATA_AND_TRIGGER [get_debug_ports u_ila_0/probe3]
set_property port_width 32 [get_debug_ports u_ila_0/probe3]
connect_debug_port u_ila_0/probe3 [get_nets [list {cache_cmd[0]} {cache_cmd[1]} {cache_cmd[2]} {cache_cmd[3]} {cache_cmd[4]} {cache_cmd[5]} {cache_cmd[6]} {cache_cmd[7]} {cache_cmd[8]} {cache_cmd[9]} {cache_cmd[10]} {cache_cmd[11]} {cache_cmd[12]} {cache_cmd[13]} {cache_cmd[14]} {cache_cmd[15]} {cache_cmd[16]} {cache_cmd[17]} {cache_cmd[18]} {cache_cmd[19]} {cache_cmd[20]} {cache_cmd[21]} {cache_cmd[22]} {cache_cmd[23]} {cache_cmd[24]} {cache_cmd[25]} {cache_cmd[26]} {cache_cmd[27]} {cache_cmd[28]} {cache_cmd[29]} {cache_cmd[30]} {cache_cmd[31]}]]
create_debug_port u_ila_0 probe
set_property PROBE_TYPE DATA_AND_TRIGGER [get_debug_ports u_ila_0/probe4]
set_property port_width 32 [get_debug_ports u_ila_0/probe4]
connect_debug_port u_ila_0/probe4 [get_nets [list {cache_stat[0]} {cache_stat[1]} {cache_stat[2]} {cache_stat[3]} {cache_stat[4]} {cache_stat[5]} {cache_stat[6]} {cache_stat[7]} {cache_stat[8]} {cache_stat[9]} {cache_stat[10]} {cache_stat[11]} {cache_stat[12]} {cache_stat[13]} {cache_stat[14]} {cache_stat[15]} {cache_stat[16]} {cache_stat[17]} {cache_stat[18]} {cache_stat[19]} {cache_stat[20]} {cache_stat[21]} {cache_stat[22]} {cache_stat[23]} {cache_stat[24]} {cache_stat[25]} {cache_stat[26]} {cache_stat[27]} {cache_stat[28]} {cache_stat[29]} {cache_stat[30]} {cache_stat[31]}]]
create_debug_port u_ila_0 probe
...
connect_debug_port u_ila_0/probe6 [get_nets [list {state[0]} {state[1]} {state[2]} {state[3]} {state[4]} {state[5]} {state[6]} {state[7]}]]
create_debug_port u_ila_0 probe
