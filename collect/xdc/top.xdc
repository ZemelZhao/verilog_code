...
set_false_path -from [get_clocks -of_objects [get_pins clk_wiz_dut/inst/mmcm_adv_inst/CLKOUT0]] -to [get_clocks e_grxc]
set_false_path -from [get_clocks e_grxc] -to [get_clocks -of_objects [get_pins clk_wiz_dut/inst/mmcm_adv_inst/CLKOUT0]]
