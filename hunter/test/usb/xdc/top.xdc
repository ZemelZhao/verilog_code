...
set_property PACKAGE_PIN M15 [get_ports {com_txd_p[0]}]
set_property PACKAGE_PIN M17 [get_ports {com_txd_p[1]}]
set_property PACKAGE_PIN L16 [get_ports {com_txd_p[2]}]
set_property PACKAGE_PIN K18 [get_ports {com_txd_p[3]}]
...
set_property PACKAGE_PIN R19 [get_ports {cc[0]}]
set_property PACKAGE_PIN R20 [get_ports {cc[1]}]
set_property PACKAGE_PIN T19 [get_ports {sbu[0]}]
set_property PACKAGE_PIN T20 [get_ports {sbu[1]}]
